...
- **已知问题**：
  ...
  - 渲染结果的人眼确认仅覆盖「能否渲染」这一路径（TC-012 已由 sunny-zhai 于 2026-09-18 人工验收通过）；朝向/落地/贴图方向由自动化世界盒断言兜底，**TC-014~TC-018 与新增的 TC-024/TC-025 人工目视项仍待确认**（REQ-005/006/007 因此尚未关闭；清单见 `docs/testing/TEST_PLAN.md` 的「人工目视清单」M-1~M-8）
