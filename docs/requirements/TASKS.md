...
- **验证结果**：
  ...
  ④ `npm test` → **106 用例 / 102 通过 / 0 失败 / 4 跳过**；`npm run lint` 通过；`node scripts/memory.mjs check` 通过。
